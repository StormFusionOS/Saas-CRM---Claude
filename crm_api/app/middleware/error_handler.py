    ...
    def _map_status_to_error_code(self, status_code: int, detail: str) -> ErrorCode:
        ...
        if status_code == 401:
            ...
            if "signature" in detail_lower:
                return ErrorCode.ERR_WEBHOOK_SIGNATURE
            elif "inactive" in detail_lower:
                return ErrorCode.ERR_FORBIDDEN_INACTIVE
            else:
                return ErrorCode.ERR_FORBIDDEN

        elif status_code == 404:
            if "lead" in detail_lower:
                return ErrorCode.ERR_LEAD_NOT_FOUND
            elif "contact" in detail_lower:
                return ErrorCode.ERR_CONTACT_NOT_FOUND
            ...
            if "email" in detail_lower and "exists" in detail_lower:
                return ErrorCode.ERR_DUPLICATE_EMAIL
            elif "leads" in detail_lower:
                return ErrorCode.ERR_CONTACT_HAS_LEADS
            else:
