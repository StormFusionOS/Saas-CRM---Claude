...
export const SUITES: Suite[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        icon: 'bolt',
        description: 'Deep research prompts with OpenAI and knowledge base',
      },
      {
        id: 'ai-context',
        label: 'Context & RAG',
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        icon: 'search',
        description: 'SERP tracking and keyword monitoring',
      },
      {
        id: 'scrape-competitors',
        label: 'Competitors',
        route: '/scrape/competitors',
        icon: 'users',
        description: 'Monitor competitor websites',
      },
      {
        id: 'scrape-serp-explorer',
        label: 'SERP Explorer',
        route: '/scrape/serp-explorer',
        icon: 'map-pin',
      ...
      },
      {
        ...
        icon: 'link',
        description: 'Backlink and citation analysis',
      },
      {
        id: 'scrape-audits',
        label: 'Audits',
      ...
      },
      {
        id: 'scrape-settings',
        label: 'Settings',
        route: '/scrape/settings',
        icon: 'settings-gear',
        description: 'Configure scraping schedules',
      },
    ],
  },
  {
